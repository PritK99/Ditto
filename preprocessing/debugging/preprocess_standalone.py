# This script requires a .c / .cpp file as input and provides processing on that file. 
# This is a file for standalone code file, and mainly for testing and debugging the code before using it for entire raw dataset in preprocess.py.
import re
import subprocess
import sys
import os
