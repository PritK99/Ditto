...
| 3    | `clean.py`                  | `c_tokens_analyzed.csv`, `cpp_tokens_analyzed.csv`, `c_vocab_counts.csv` and `cpp_vocab_counts.csv`                                          | `c_cleaned_tokens.csv`, `cpp_cleaned_tokens.csv`,  and `final_vocab_combined.txt`                                                           | Cleans rows based on vocabulary frequencies. |
| 4    | `parser.py`                  |  `c_cleaned_tokens.csv`, `cpp_cleaned_tokens.csv`,  and `final_vocab_combined.txt`          |                    `c_tokens_with_lca_dist.csv` and `cpp_tokens_with_lca_dist.csv`                           | Calculates LCA distance |
| 5    | `compress.py`                  |  `c_tokens_with_lca_dist.csv` and `cpp_tokens_with_lca_dist.csv`         |                    `c_tokens_with_lca_dist.parquet` and `cpp_tokens_with_lca_dist.parquet`                            | Filters columns needed for training |
