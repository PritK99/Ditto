...
def train_transformer(model, train_loader_1, train_loader_2, val_loader_1, val_loader_2, dataset, phase,
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        print("C2C")
        predicted_code_tokens_1 = predict(model, input_c_code_tokens, dataset, flag = True)
        print(predicted_code_tokens_1, flush=True)

        print("C2C++")
        predicted_code_tokens_2 = predict(model, input_c_code_tokens, dataset, flag = False)
        print(predicted_code_tokens_2, flush=True)

        print("C++2C++")            
        predicted_code_tokens_3 = predict(model, input_cpp_code_tokens, dataset, flag = False)
        print(predicted_code_tokens_3, flush=True)

        print("C++2C")            
        predicted_code_tokens_4 = predict(model, input_cpp_code_tokens, dataset, flag = True)
        print(predicted_code_tokens_4, flush=True)
...
trainer = train_transformer(model, dataloader_1, dataloader_2, valloader_1, valloader_2, dataset1, phase = 2, num_epochs = 20, load_path = './best_model.pt')