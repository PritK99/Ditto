...
GRAMMAR_LIB_PATH = os.path.expanduser('~/tree-sitter-cpp/cpp_language_lib.so')
...
def main_worker(c_code_string: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        c_lang = load_cpp_language(GRAMMAR_LIB_PATH)
        parser = Parser()
...
if __name__ == "__main__":
    ...
    INPUT_FILE = "unpaired_cpp.txt" # 🎯 Changed input file name
